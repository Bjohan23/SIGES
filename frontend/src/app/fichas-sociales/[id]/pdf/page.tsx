  ...
  useEffect(() => {
    const generatePDF = async () => {
      ...
      try {
        ...
        doc.setFontSize(8);
        doc.text(`Generado: ${new Date().toLocaleString("es-PE")}`, pageWidth / 2, 35, {
          align: "center",
        });
        ...
        autoTable(doc, {
          ...
          body: [
            ...
            [
              ficha.nacionalidad === "Peruana" ? "DNI" : "Carné de Extranjería",
              ficha.dni || ficha.carne_extranjeria || "N/A",
            ],
        ...
        if (ficha.datos_economicos) {
          ...
          const totalIngresos =
            (ficha.datos_economicos.ingresos.trabajador || 0) +
          ...
          autoTable(doc, {
            ...
            body: [
              [
                ...
                formatCurrency(ficha.datos_economicos.ingresos.trabajador),
              ],
          ...
          egresosData.push([
            "  Agua",
            formatCurrency(ficha.datos_economicos.egresos.servicios_basicos.agua),
          ]);
          egresosData.push([
            "  Luz",
            formatCurrency(ficha.datos_economicos.egresos.servicios_basicos.luz),
          ]);
          egresosData.push([
            "  Teléfono",
            formatCurrency(ficha.datos_economicos.egresos.servicios_basicos.telefono),
          ]);
          egresosData.push([
            "  Internet",
            formatCurrency(ficha.datos_economicos.egresos.servicios_basicos.internet),
          ]);
          egresosData.push([
            "  Cable",
            formatCurrency(ficha.datos_economicos.egresos.servicios_basicos.cable),
          ]);
          ...
          egresosData.push([
            "  Alimentación",
            formatCurrency(ficha.datos_economicos.egresos.gastos_familiares.alimentacion),
          ]);
          egresosData.push([
            "  Educación",
            formatCurrency(ficha.datos_economicos.egresos.gastos_familiares.educacion),
          ]);
          egresosData.push([
            "  Salud",
            formatCurrency(ficha.datos_economicos.egresos.gastos_familiares.salud),
          ]);
          egresosData.push([
            "  Transporte",
            formatCurrency(ficha.datos_economicos.egresos.gastos_familiares.transporte),
          ]);
          egresosData.push([
            "  Vestimenta",
            formatCurrency(ficha.datos_economicos.egresos.gastos_familiares.vestimenta),
          ]);
          ...
          egresosData.push([
            "  Préstamos",
            formatCurrency(ficha.datos_economicos.egresos.deudas_seguros.prestamos),
          ]);
          egresosData.push([
            "  Seguros",
            formatCurrency(ficha.datos_economicos.egresos.deudas_seguros.seguros),
          ]);

          const totalEgresos =
            Object.values(ficha.datos_economicos.egresos.servicios_basicos).reduce(
              (sum, val) => sum + (val || 0),
              0
            ) +
            Object.values(ficha.datos_economicos.egresos.gastos_familiares).reduce(
              (sum, val) => sum + (val || 0),
              0
            ) +
            Object.values(ficha.datos_economicos.egresos.deudas_seguros).reduce(
              (sum, val) => sum + (val || 0),
              0
            );
          ...
          autoTable(doc, {
            ...
            didParseCell: function (data) {
              // Resaltar filas de encabezados de secciones (SERVICIOS BÁSICOS, GASTOS FAMILIARES, DEUDAS Y SEGUROS)
              if (data.section === "body" && [0, 6, 12].includes(data.row.index)) {
                data.cell.styles.fillColor = [254, 226, 226];
                data.cell.styles.fontStyle = "bold";
              }
              // Resaltar fila de TOTAL EGRESOS
            ...
            didParseCell: function (data) {
              if (data.section === "body") {
                if (data.row.index === 0) {
                  ...
                  data.cell.styles.fillColor = balance >= 0 ? [219, 234, 254] : [254, 215, 170];
                }
              }
            },
            margin: { left: 15, right: 15 },
        ...
        if (ficha.datos_vivienda) {
          ...
          if (ficha.datos_vivienda.material?.length) {
            viviendaSaludData.push([
              ...
              ficha.datos_vivienda.material.join(", "),
            ]);
          }
          ...
          if (ficha.datos_vivienda.servicios?.length) {
            viviendaSaludData.push([
              "Servicios Básicos",
              ficha.datos_vivienda.servicios.join(", "),
            ]);
          }
          ...
          if (ficha.datos_vivienda.problemas_sociales?.length) {
            viviendaSaludData.push([
              "Problemas Sociales",
              ficha.datos_vivienda.problemas_sociales.join(", "),
            ]);
          }
        }
        ...
        if (ficha.datos_salud) {
          ...
          if (ficha.datos_salud.alergias?.tiene) {
            viviendaSaludData.push([
              "Alergias",
              ficha.datos_salud.alergias.especificar || "Sí (sin especificar)",
            ]);
          }
          ...
          if (ficha.datos_salud.enfermedades?.tiene) {
            viviendaSaludData.push([
              ...
              ficha.datos_salud.enfermedades.especificar || "Sí (sin especificar)",
            ]);
          }
          ...
          if (ficha.datos_salud.discapacidad?.tiene) {
            viviendaSaludData.push([
              "Discapacidad",
              `${ficha.datos_salud.discapacidad.tipo || "N/A"} - Grado: ${
                ficha.datos_salud.discapacidad.grado || "N/A"
              }`,
            ]);
          }
        }
        ...
        if (ficha.declaracion_jurada) {
            ...
            body: [
              ...
              [
                ...
                ficha.declaracion_jurada.fecha_firma
                  ? formatDate(ficha.declaracion_jurada.fecha_firma)
                  : "N/A",
              ],
            ],
            theme: "striped",
          ...
          if (ficha.declaracion_jurada.firma_digital) {
            ...
            try {
              doc.addImage(ficha.declaracion_jurada.firma_digital, "PNG", 15, yPosition, 80, 30);
            } catch (e) {
        ...
        for (let i = 1; i <= totalPages; i++) {
          ...
          doc.text("I.E. Nicolas La Torre Garcia - Chiclayo", pageWidth / 2, pageHeight - 5, {
            align: "center",
          });
        }

        // Guardar PDF
        const fileName = `ficha-social-${ficha.apellido_paterno || ficha.apellidos}-${
          ficha.nombres
        }.pdf`.replace(/\s+/g, "-");
        doc.save(fileName);

...
// app/registros/informe-visita-domiciliaria/nuevo/page.tsx
// Página para crear nuevo Informe de Visita Domiciliaria
...
import { InformeVisitaDomiciliariaService, CreateInformeVisitaDomiciliariaData } from '@/services/InformeVisitaDomiciliariaService'

export default function NuevoInformeVisitaDomiciliariaPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const data: CreateInformeVisitaDomiciliariaData = {
      ...
      await InformeVisitaDomiciliariaService.createInformeVisitaDomiciliaria(data)
      setSuccess('Informe de visita domiciliaria creado exitosamente')
      setTimeout(() => {
        router.push('/registros/informe-visita-domiciliaria')
      }, 1500)
    } catch (err: any) {
      setError(err.message || 'Error al crear el informe de visita domiciliaria')
    } finally {
      setLoading(false)
    }
  }
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
            Nuevo Informe de Visita Domiciliaria
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Complete los datos del informe
          </p>
        </div>

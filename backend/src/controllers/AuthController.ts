...
export class AuthController extends BaseController {
  ...
  refreshToken = this.asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  logout = auditAction({
    ...
    this.asyncHandler(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  ...
  getProfile = this.asyncHandler(async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  ...
  validateToken = this.asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
